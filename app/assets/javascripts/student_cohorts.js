...
$(document).ready(function () {
    if (document.querySelector('body.student_cohorts.index') == undefined) {
        return;
    }
    ...
    $('.delete-cohort').on('ajax:success', function (e) {
        ...
        $(e.target).parents(".std-cohort").remove();

        toastr.success('Your Student-Cohort has been successfully DELETED');
    });
});
