...
$(document).ready(function () {
    if (document.querySelector('body.instructor_cohorts.index') == undefined) {
        return;
    }
    ...
    $('.delete-instructor').on('ajax:success', function (e) {
        $(e.target).parents('.main-instructor').remove();
        toastr.success('Your Instructor-Cohort has been successfully DELETED');
    });
});
